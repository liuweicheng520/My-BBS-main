...
;layui.define(["layer", "form"], function (t) {
    ...
    var s = function (t, i, a) {
        ...
        italic: '<i class="layui-icon layedit-tool-i" title="Italics" lay-command="italic" layedit-event="i"">&#xe644;</i>',
        underline: '<i class="layui-icon layedit-tool-u" title="Underline" lay-command="underline" layedit-event="u"">&#xe646;</i>',
        del: '<i class="layui-icon layedit-tool-d" title="Drop line" lay-command="strikeThrough" layedit-event="d"">&#xe64f;</i>',
        "|": '<span class="layedit-tool-mid"></span>',
        left: '<i class="layui-icon layedit-tool-left" title="Left aligned" lay-command="justifyLeft" layedit-event="left"">&#xe649;</i>',
        center: '<i class="layui-icon layedit-tool-center" title="Center aligned" lay-command="justifyCenter" layedit-event="center"">&#xe647;</i>',
        ...
        unlink: '<i class="layui-icon layedit-tool-unlink layui-disabled" title="Clear Links" lay-command="unlink" layedit-event="unlink"">&#xe64d;</i>',
