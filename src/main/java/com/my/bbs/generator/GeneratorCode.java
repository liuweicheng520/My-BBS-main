package com.my.bbs.generator;

import com.my.bbs.util.StringUtil;
...
GeneratorCode {
	...
	//JDBC配置，请修改为你项目的实际配置
	private static final String JDBC_DATABASE = "my_bbs_db";
	private static final String JDBC_URL = "jdbc:mysql://liuy24.mysql.database.azure.com:3306/" + JDBC_DATABASE;
	private static final String JDBC_USERNAME = "liuy24";
	private static final String JDBC_PASSWORD = "testsql123..";
	private static final String JDBC_DIVER_CLASS_NAME = "com.mysql.cj.jdbc.Driver";


	public static void main(String[] args) throws Exception {
		genCodeByTableNames("admin", "tb_post_comment");//
	}
...
//			genService(platformUrl, tableName); // 生成service
	...
	public static void genService(String platformUrl, String tableName) throws Exception {
		...
		tableDO.setClassName(StringUtil.capitalize(StringUtil.snakeToCapHump(className)));
		tableDO.setClassname(StringUtil.uncapitalize(StringUtil.snakeToCapHump(className)));
	...
	genModelAndMapper(String platformUrl, String tableName) throws Exception {
		List<String> templates = new ArrayList<String>();
...
//		templates.add("generator/Mapper.java.vm");
	...
	public static String getFileName(String template, String classname, String className, String packageName, String platformUrl) {
		...
		if (template.contains("domain.java.vm")) {
			packagePath +=  File.separator + "src/main/java" + File.separator + packageName.replace(".", File.separator) + File.separator;
